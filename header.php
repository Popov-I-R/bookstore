    ...
    <div class="col-md">
        <div class="vertical-nav bg-white" id="sidebar">
            <div class="py-4 px-3 mb-4 bg-light">
                <!-- Начало потр. име - Ако потребителя е логнат излиза името му над надписа "Добре дошли". В противен случай на мястото на потребителското име пише "Гост".-->
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <?php if (isset($_SESSION['login_user'])) { ?>
                                <div class="profile">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-person-fill"></i> Профил
                                            <!--След логин се превръща в "Профил"-->
                                        </a>
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <?php } else { ?>
                                <div class="login">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-person-fill"></i> Вход / Регистрация
                                        </a>
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <button id="cart" type="button" onclick="location.href = '<?php echo URLBASE ?>/view-cart.php';" class="btn btn-light bg-white rounded-pill shadow-sm px-4 mb-4"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-shopping-cart" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    </svg><span class="text-number">  </span>
                </button>
            </div>
        </div>
    </div>
