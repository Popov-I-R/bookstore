...
<!--                <li class="nav-item">
  ...
  <line x1="5" y1="18" x2="5" y2="18.01" />
                ...
                <li class="nav-item">
                    <a href="<?php echo URLBASE; ?>/backend/all-users.php" class="nav-link text-dark font-italic">
  ...
  <line x1="16" y1="11" x2="14" y2="13" />
                ...
                <li class="nav-item">
                    <a href="<?php echo URLBASE; ?>/backend/all-orders.php" class="nav-link text-dark font-italic">
